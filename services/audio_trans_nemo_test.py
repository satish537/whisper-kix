...
def process_audio_file1(audio_path, output_dir, enable_stemming=True, batch_size=8, suppress_numerals=True):
    # Load the Whisper model inside the function
    device = "cuda" if torch.cuda.is_available() else "cpu"
#    whisper_model = whisperx.load_model("small", device=device, compute_type="float32")
